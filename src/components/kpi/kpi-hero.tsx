...
const statusTone: Record<Headline["status"], { dot: string; text: string; label: string }> = {
  healthy: { dot: "bg-positive", text: "text-positive", label: "Healthy" },
  watch:   { dot: "bg-warning",  text: "text-warning",  label: "Watch"   },
  action:  { dot: "bg-negative", text: "text-negative", label: "Action"  },
}
    ...
    >
      <div className="grid items-end gap-8 lg:grid-cols-[1fr_auto]">
        <div className="min-w-0">
          <div
            className="inline-flex items-center gap-2.5 font-sans text-[11px] font-semibold uppercase tracking-[0.22em]"
          ...
          <p
            className="mt-4 max-w-[900px] font-serif font-light leading-[1.18] tracking-[-0.022em]"
            style={{
        ...
        <div className="flex flex-col items-end gap-3">
          <span
            className={`inline-flex items-center gap-2 rounded-full px-3 py-1.5 font-sans text-[12px] font-medium ${tone.text}`}
